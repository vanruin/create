...
def autocr(firstn,lastn,passw):
  global loop, ok
  try:
        sys.stdout.write("\r \33[1;35m \033[1;37m(\033[1;36m%s\033[1;37m/\033[1;31m%s\033[1;35m) \033[1;32mSUCCESS:-%s"%(loop,l,len(ok)));sys.stdout.flush()
        ua=random.choice(open("TOOLS/ambot/crack/ua.txt","r").read().splitlines())
